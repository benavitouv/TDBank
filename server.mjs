...
const WEBHOOK_URL = getEnv(
  'WEBHOOK_URL',
  'https://api.demo.wonderful.ai/api/v1/tasks/webhook/1015d1c1-cb6b-4bdd-9f7b-742d10d6b47c'
);
const WEBHOOK_SECRET = getEnv(
  'WEBHOOK_SECRET',
  'a2a1f83d-9a18-4655-ab19-1cf9e6feaa33'
);
...
const triggerWebhook = async ({ email, firstName, lastName, attachmentId }) => {
  const subject = `בקשת הלוואה - ${firstName} ${lastName}`.trim();
